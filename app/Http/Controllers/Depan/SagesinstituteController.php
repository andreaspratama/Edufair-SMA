...
use App\Models\Sagesinstitute;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class SagesinstituteController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.sagesinstitute.index');
    }

...
use App\Models\Widyamandala;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class WidyamandalaController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.widyamandala.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'UNIKA WIDYA MANDALA SURABAYA'; 
        $daftar->signed = $signature; 
        $daftar->save();
        // $jon = new Widyamandala;
        // $jon->nama = $request->nama;
        // $jon->kelas = $request->kelas;
        // $jon->noabsen = $request->noabsen;
        // $jon->universitas = 'WIDYAMANDALA';

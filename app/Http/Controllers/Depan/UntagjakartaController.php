...
use App\Models\Untagjakarta;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class UntagjakartaController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.untagjakarta.index');
    }

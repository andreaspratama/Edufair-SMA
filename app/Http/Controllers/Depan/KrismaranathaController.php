...
use App\Models\Krismaranatha;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class KrismaranathaController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.krismaranatha.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'UNIVERSITAS KRISTEN MARANATHA'; 
        $daftar->signed = $signature; 
        $daftar->save();
        // $jon = new Krismaranatha;
        // $jon->nama = $request->nama;
        // $jon->kelas = $request->kelas;
        // $jon->noabsen = $request->noabsen;
        // $jon->universitas = 'KRISMARANATHA';

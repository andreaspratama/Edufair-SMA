...
use App\Models\Ikado;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class IkadoController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.ikado.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'INSTITUT INFORMATIKA INDONESIA (IKADO) SURABAYA'; 

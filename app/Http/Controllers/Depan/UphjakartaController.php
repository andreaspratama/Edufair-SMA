...
use App\Models\Uphjakarta;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class UphjakartaController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.uphjakarta.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'UNIVERSITAS PELITA HARAPAN JAKARTA'; 

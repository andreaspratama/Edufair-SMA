...
use App\Models\Udinus;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class UdinusController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.udinus.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'UNIVERSITAS DIAN NUSWANTORO '; 

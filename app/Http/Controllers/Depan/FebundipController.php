...
use App\Models\Febundip;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class FebundipController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.febundip.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'IUP FEB UNDIP'; 

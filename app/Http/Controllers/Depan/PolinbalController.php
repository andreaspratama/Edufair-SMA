...
use App\Models\Polinbal;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class PolinbalController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.polinbal.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'POLITEKNIK INTERNASIONAL BALI'; 

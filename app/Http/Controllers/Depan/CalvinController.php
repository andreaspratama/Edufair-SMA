...
use App\Models\Calvin;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class CalvinController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.calvin.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'CALVIN UNIVERSITY'; 

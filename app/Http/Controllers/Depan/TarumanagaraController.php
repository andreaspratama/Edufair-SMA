...
use App\Models\Tarumanagara;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class TarumanagaraController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.tarumanagara.index');
    }

...
use App\Models\Ciputra;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class CiputraController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.ciputra.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'UNIVERSITAS CIPUTRA'; 

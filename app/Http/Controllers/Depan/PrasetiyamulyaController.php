...
use App\Models\Prasetiyamulya;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class PrasetiyamulyaController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.prasetiyamulya.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'UNIVERSITAS PRASETIYA MULYA'; 
        $daftar->signed = $signature; 
        $daftar->save();
        // $jon = new Prasetiyamulya;
        // $jon->nama = $request->nama;
        // $jon->kelas = $request->kelas;
        // $jon->noabsen = $request->noabsen;
        // $jon->universitas = 'PRASETIYAMULYA';

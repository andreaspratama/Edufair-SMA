...
use App\Models\Parahyangan;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class ParahyanganController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.parahyangan.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'UNIVERSITAS PARAHYANGAN'; 

...
use App\Models\Karangturi;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class KarangturiController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.karangturi.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'UNIVERSITAS KARANGTURI'; 

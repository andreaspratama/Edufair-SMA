...
use App\Models\Xiamen;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class XiamenController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.xiamen.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'XIAMEN UNIVERSITY'; 

...
use App\Models\Sttabdiel;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class SttabdielController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.sttabdiel.index');
    }

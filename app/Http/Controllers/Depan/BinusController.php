...
use App\Models\Binus;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class BinusController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.binus.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'UNIVERSITAS BINA NUSANTARA'; 

...
use App\Models\Kristenpetra;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class KristenpetraController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.kristenpetra.index');
    }

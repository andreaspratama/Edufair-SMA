...
use App\Models\Soegijapranata;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class SoegijapranataController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.soegijapranata.index');
    }

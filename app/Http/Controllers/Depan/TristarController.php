...
use App\Models\Tristar;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class TristarController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.tristar.index');
    }
    ...
    public function store(Request $request)
    {
        ...
        $daftar->universitas = 'TRISTAR CULINARY INSTITUTE'; 

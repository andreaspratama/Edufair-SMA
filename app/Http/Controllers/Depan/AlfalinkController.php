...
use App\Models\Alfalink;
use App\Http\Requests\Admin\PendaftaranRequest;
use App\Models\Pendaftaran;
use Carbon\Carbon;

class AlfalinkController extends Controller
{
    /**
    ...
    {
        return view('pages.depan.alfalink.index');
    }

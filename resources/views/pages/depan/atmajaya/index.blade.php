...
<body class="bg-primary">
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <form style="background-color: #fff; padding: 40px; border-radius: 10px" method="POST" action="{{ route('atmajayaDaftar') }}" enctype="multipart/form-data">
                    <h3 style="font-size: 20px">Edufair SMA Kristen YSKI - UNIVERSITAS ATMA JAYA YOGYAKARTA</h3>
                    @csrf

...
<body class="bg-primary">
    <div class="container">
        <div class="row">
            <div class="col-md-7 ml-auto mr-auto offset-md-3 mt-5 mb-5">
                <div class="card">
                    <div class="card-header">
                        <h5>Edufair SMA Kristen YSKI - Universitas USM</h5>
                    </div>
                    <div class="card-body">
                        @if (session('success'))
                        ...
                        @endif
                        <form method="POST" action="{{ route('usm.store') }}" enctype="multipart/form-data">
                            @csrf

    ...
    <div class="container-fluid">
        ...
        {{-- <div class="row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="" onclick="this.href='/pendaftaran/pilih/'+ document.getElementById('universitas').value" class="btn btn-primary py-2">Filter</a>
                    </div>
                </div>
            </div>
        </div> --}}
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <a href="{{route('daftar')}}" class="btn btn-primary">Kembali Mencari</a>
            </div>
            <div class="card-body">
